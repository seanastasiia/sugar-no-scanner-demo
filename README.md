...
- a vertical expanded ranking that puts the highest verified Sugar.no fit first, keeps `Great / Moderate / Low fit` attached to every row and places unrated identities last as `Fit pending`;
