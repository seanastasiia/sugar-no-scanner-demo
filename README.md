...
- `POST /api/resolve-products`: up to ten image-free identities, returns optional exact retailer/nutrition enrichment. Five uncatalogued products resolve concurrently in one bounded wave; successful exact web lookups remain cached for 24 hours in the running service.
