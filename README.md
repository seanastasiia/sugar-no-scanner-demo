...
Preview acceptance and its unresolved local WebKit startup-test limitation are recorded in [expansion QA](docs/test-runs/2026-09-04-personal-fit-expansion.md). The published HTTPS health, exact-source data and targeted mobile-emulation smoke pass; a physical-phone shelf check remains part of owner acceptance.
