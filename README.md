...
- Expanded multi-product results keep `Best fit first` and the original ranked cards. The separate AR (My) preview can expose the opt-in `Personal Shelf Rank · Pilot` switch; launch hides it. Duplicate scan-again controls remain omitted.
