...
5. Confirm a physical price appears only when a price label is visible and an exact cheaper Barbora result is clearly qualified.
6. Move the camera after a result and confirm it remains held until `Scan again`.
