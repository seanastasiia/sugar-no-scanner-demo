...
The checked-in preview contains **5,150 exact source observations: 1,343 complete scores, 2,369 provisional ranges and 1,438 unscored records**. The 4 September bounded expansion added **377 assessments**, from 3,335 to 3,712: 86 from a 200-card evidence pilot, 229 from reviewed source categories, 19 from 50 original OFF follow-ups and 43 from 136 newly imported OFF follow-ups. The independent OFF identity-only layer adds 9,626 barcode/name records but no observations or scores, so it does not alter those rating totals. All 3,335 previously assessed results and both demos retain their values. These are source/SKU records, not globally deduplicated products or recognition accuracy. Original Fit's formula and all category weights remain unchanged. Barcode package labels preserve grams versus millilitres. Detailed scope, commands and outstanding prerequisites are in [the expansion plan](docs/personal-fit-expansion-plan.md) and [the ordered OFF/CSP/enrichment plan](docs/off-csp-incomplete-enrichment-plan.md).
