...
Preview acceptance and its unresolved local WebKit startup-test limitation are recorded in [expansion QA](docs/test-runs/2026-09-04-personal-fit-expansion.md). The subsequent OFF/CSP/enrichment data, staging and live checks are recorded in [7 September catalog QA](docs/test-runs/2026-09-07-off-csp-enrichment.md). The published HTTPS health, exact-source data and targeted mobile-emulation smoke pass; a physical-phone shelf check remains part of owner acceptance.
