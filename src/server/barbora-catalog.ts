...
const synonymMap: Record<string, string[]> = {
  ...
  sour: ["skaba", "skabas", "skabais", "skabo"],
  skaba: ["sour", "skabas", "skabais", "skabo"],
  skabas: ["sour", "skaba", "skabais", "skabo"],
  skabais: ["sour", "skaba", "skabas", "skabo"],
  skabo: ["sour", "skaba", "skabas", "skabais"],
  cream: ["krej", "krejuma", "krejums", "krejumu"],
  krej: ["cream", "krejuma", "krejums", "krejumu"],
  krejuma: ["cream", "krej", "krejums", "krejumu"],
  krejums: ["cream", "krej", "krejuma", "krejumu"],
  krejumu: ["cream", "krej", "krejuma", "krejums"],
  onion: ["sip", "sipoli", "sipoliem", "sipols", "sipolu"],
  onions: ["sip", "sipoli", "sipoliem", "sipols", "sipolu"],
  sip: ["onion", "onions", "sipoli", "sipoliem", "sipols", "sipolu"],
  sipoli: ["onion", "onions", "sip", "sipoliem", "sipols", "sipolu"],
  sipoliem: ["onion", "onions", "sip", "sipoli", "sipols", "sipolu"],
  sipols: ["onion", "onions", "sip", "sipoli", "sipoliem", "sipolu"],
  sipolu: ["onion", "onions", "sip", "sipoli", "sipoliem", "sipols"],
