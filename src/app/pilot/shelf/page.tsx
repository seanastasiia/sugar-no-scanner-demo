...
export default async function ShelfPilotPage() {
  ...
  return <ScannerApp sampleComparison={onboardingComparison()} ownerAccess={ownerAccess} personalRankAvailable shelfResearchEnabled paywallEnabled={!ownerAccess && process.env.WTP_PAYWALL_ENABLED === "true"} />;
}
