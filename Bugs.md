...
- **2026-08-28: the cheaper-online action was visually secondary and repeated `Barbora online` beside the price.** Exact cheaper offers now use one full-width green `Buy cheaper online` action with the destination price, while the separate visible price row omits retailer copy.
