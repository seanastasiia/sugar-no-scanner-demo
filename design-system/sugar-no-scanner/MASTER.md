...
**Project:** Sugar.no Scanner
**Generated:** 2026-08-20 12:40:32
...
| Secondary | `#6F655D` | `--color-secondary` |
| Accent/CTA | `#E8614A` | `--color-accent` |
| Background | `#F2EDE4` | `--color-background` |
| Foreground | `#111111` | `--color-foreground` |
| Muted | `#F8F4EE` | `--color-muted` |
| Border | `#E8E2D8` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#E8614A` | `--color-ring` |

**Color Notes:** Existing Sugar.no cream, ink and coral identity. Coral is an accent, not a negative food verdict.
...
- **Google Fonts:** [Playfair Display + Inter](https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Playfair+Display:ital,wght@0,700;1,700&display=swap)
