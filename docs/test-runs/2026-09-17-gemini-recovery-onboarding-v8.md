# Gemini recovery and onboarding version 8 — release-candidate QA
...
- Production remains unchanged until the owner gives a fresh `ПУБЛИКУЙ` approval.
...
- Paid Gemini quota or another verified resolver remains necessary before increasing advertising traffic. No billing change was made.
