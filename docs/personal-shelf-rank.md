...
For an immediate camera-free example, open [New rating demo](https://sugar-no-scanner-demo-production.up.railway.app/demo/personal-shelf). Its six selected catalog records use the same scorer: chips 64/61, real PROPER lentil chips 57–59 with unknown fiber, one unscored contradictory-source chip, and yogurts 97/54. This is a labelled selection, not a recognition test or market-wide ranking. No refresh or provider request is made by the demo.
